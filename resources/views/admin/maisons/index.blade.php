    ...
    <div class="card border-primary mb-3">
        <div style="padding: 25px" class="container-fluid">
            <div class="card mb-3">
                ...
                @else
                    <img src="{{asset('web/images/'.$maisons->where('rang',$rang[0])->first()->image_presentation)}}" width="500" height="400" class="card-img-top" alt="maison 1">
                @endempty
                <div class="card-body">
                    @empty($maisons->where('rang',$rang[0])->first())
            ...
            <div class="card mb-3">
                ...
                @else
                    <img src="{{asset('web/images/'.$maisons->where('rang',$rang[1])->first()->image_presentation)}}" width="500" height="400" class="card-img-top" alt="maison 2">
                @endempty
                <div class="card-body">
                    @empty($maisons->where('rang',$rang[1])->first())
                        <h5 class="card-title">Titre vide</h5>
            ...
            <div class="card mb-3">
                ...
                @else
                    <img src="{{asset('web/images/'.$maisons->where('rang',$rang[3])->first()->image_presentation)}}" width="500" height="400" class="card-img-top" alt="maison 4">
                @endempty
                <div class="card-body">
                    @empty($maisons->where('rang',$rang[3])->first())
                        <h5 class="card-title">Titre vide</h5>
            ...
            <div class="card mb-3">
                @empty($maisons->where('rang',$rang[4])->first())
                    <img src="{{asset('web/images/dark.jpg')}}" width="500" height="400" class="card-img-top" alt="maison 4">
                @else
                    <img src="{{asset('web/images/'.$maisons->where('rang',$rang[4])->first()->image_presentation)}}" width="500" height="400" class="card-img-top" alt="maison 4">
                @endempty
                <div class="card-body">
                    @empty($maisons->where('rang',$rang[4])->first())
                        <h5 class="card-title">Titre vide</h5>
            ...
            <div class="card mb-3">
                @empty($maisons->where('rang',$rang[5])->first())
                    <img src="{{asset('web/images/dark.jpg')}}" width="500" height="400" class="card-img-top" alt="maison 4">
                @else
                    <img src="{{asset('web/images/'.$maisons->where('rang',$rang[5])->first()->image_presentation)}}" width="500" height="400" class="card-img-top" alt="maison 4">
                @endempty
                <div class="card-body">
                    @empty($maisons->where('rang',$rang[5])->first())
                        <h5 class="card-title">Titre vide</h5>
