<body>
        ...
        <div class="agileits_w3layouts_banner_nav">
            ...
            <nav class="navbar navbar-default">
                <div class="navbar-header navbar-left">
                    ...
                    <h1>
                        <a class="navbar-brand" href="{{ route('acceuil') }}"> <span>B</span>aqiath</a>
                        <img width="50" height="48" src="{{ asset('web/images/petitlogo.jpg') }}" alt="logo de baqiath">
                    </h1>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <nav class="link-effect-2" id="link-effect-2">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="{{ route('acceuil') }}"
                                    class="effect-3">{{ __('messages.acceuil_title') }}</a></li>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle effect-3"
                                    data-toggle="dropdown">{{ __('messages.lang_title') }}<b class="caret"></b></a>
                            ...
                            <li><a href="{{ route('mailus') }}" class="effect-3">{{ __('messages.contact_title') }}</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    <div class="banner_top">
        <div class="slider">
            <div class="wrapper">
                    ...
                    <div class="w3-button">
                        ...
                        <center>
                            <div class="w3l-button">
                                <a href="#portfolio"
                                    class="hvr-shutter-out-vertical scroll ">{{ __('messages.maisons_button') }}</a>
                            </div>
                        </center>
                        <div class="clearfix"> </div>
                    </div>
                ...
                <!-- Slideshow 3 Pager -->
                <ul id="slider3-pager">
                    <li><a href="#"><img src="{{ asset('web/images/banner11.jpg') }}" data-selector="img" alt=""></a>
                    </li>
                    <li><a href="#"><img src="{{ asset('web/images/banner22.jpg') }}" data-selector="img" alt=""></a>
                    </li>
                    <li><a href="#"><img src="{{ asset('web/images/banner33.jpg') }}" data-selector="img" alt=""></a>
                    </li>
                    <li><a href="#"><img src="{{ asset('web/images/banner44.jpg') }}" data-selector="img" alt=""></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    {{-- <div class="medile_section" id="three_grids">
        ...
        <div class="col-md-3 mid-text-info">
            ...
            <p>Lorem Ipsum is simply text the printing and typesetting standard industry. Lorem Ipsum has been the
                industry's standard
                dummy text.</p>
        </div>
